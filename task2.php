...
if ($argc != 2)
{
    echo 'Программа принимает на вход только имя пользователя!';
    return;
}
...
$alpha = array (
    ...
    $user_lname = latinize(mb_strtolower($user_rname, "UTF-8"));
    ...
    */
	#Команда pwgen работает только на linux, на комп. классах в петргу пакеты с этой командой не скачаны, прикол
    $user_pass = 'password';
	
echo 'Имя пользователя: ', $user_lname, ',', 'Пароль: ',  $user_pass;
exit(45);
?>
